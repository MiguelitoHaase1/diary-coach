...
class ConversationTestRunner:
    ...
    async def run_conversation_test(self, test_name: str = "PM_coaching_session") -> Dict[str, Any]:
        ...
        while turn_count < max_turns:
            ...
            result = await coaching_graph.ainvoke(state)
            coach_response = result.get('coach_response', '') if isinstance(result, dict) else result.coach_response
