...
class MarkdownDocumentLoader:
    ...
    async def load_documents(self, state: ContextState) -> ContextState:
        ...
        try:
            ...
            documents, metadata = await self._load_and_score_documents(
            ...
            state.context_usage.update({
                ...
                "document_relevance_scores": {
                    doc["filename"]: doc["relevance_score"] for doc in documents
                },
                "document_metadata": metadata,
                "document_load_time_ms": int(
    ...
    async def _load_and_score_documents(
        ...
        markdown_files = list(self.documents_path.rglob("*.md"))
        ...
        for file_path in markdown_files:
            try:
                ...
                # Extract document metadata with relative path
                ...
                relevance_score = self._calculate_document_relevance(
                    content, conversation_context, str(relative_path)
                )
    ...
    def _calculate_document_relevance(
        self, content: str, conversation_context: str, filename: str
    ) -> float:
    ...
    def _filter_by_relevance(
        self, documents: List[Dict[str, Any]], conversation_context: str
    ) -> Dict[str, str]:
